    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800">Edit Student Information</h1>
          <p className="text-gray-600 mt-2">Update student personal and academic information</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            <button
              type="submit"
              className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 shadow-md"
            >
              Save Changes
            </button>
            <button
